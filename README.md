...
[![Version](https://img.shields.io/badge/version-38.0.5-blue.svg)](https://github.com/BernardBourbaki/Cryptage/releases)
...
* **V37 / V37.1 / V37.2 / V37.2.1 / V37.3 / V37.3.1 / V38.0.0 / V38.0.1 / V38.0.2 / V38.0.3 / V38.0.4 / V38.0.5** : Déchiffre **UNIQUEMENT** les fichiers .crypt créés avec V37+
...
1. Téléchargez Cryptage_V38.0.5.exe depuis [Releases](https://github.com/BernardBourbaki/Cryptage/releases/latest)
...
```bash
gcc -finput-charset=UTF-8 -fexec-charset=CP1252 Cryptage_Main.c Cryptage_Core.c Cryptage_UI_Common.c Cryptage_UI.c -o Cryptage_V38.0.5.exe -lssl -lcrypto -lgdi32 -lcomctl32 -mwindows
```
...
* Gardez plusieurs copies du logiciel Cryptage_V38.0.5.exe
