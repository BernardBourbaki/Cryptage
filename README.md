...
1. Si vous voulez une version locale, légère, idéale pour des tests : gcc -finput-charset=UTF-8 -fexec-charset=CP1252 -o Cryptage_V37.2.1.exe Cryptage_Main.c Cryptage_Core.c Cryptage_UI_Common.c Cryptage_UI.c -lssl -lcrypto -lws2_32 -lcrypt32 -lgdi32 -lcomctl32 -mwindows
