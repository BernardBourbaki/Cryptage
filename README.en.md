...
* **V37 / V37.1 / V37.2 / V37.2.1 / V37.3 / V37.3.1 / V38.0.0 / V38.0.1 / V38.0.2 / V38.0.3 / V38.0.4 / V38.0.5**: Decrypts **ONLY** .crypt files created with V37+
...
1. Download Cryptage_V38.0.5.exe from [Releases](https://github.com/BernardBourbaki/Cryptage/releases/latest)
...
* Keep several copies of the Cryptage_V38.0.5.exe program
